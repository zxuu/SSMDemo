...
public class SendPhoneData {
    public static void sendRFIDData(String s){
        /*
        *创建UDP传输的发送端
        * 思路：
...
//            String str ="udp传输，udp手机端服务器终于搞定了";
            ...
            DatagramPacket dp = new DatagramPacket(buf,buf.length, InetAddress.getByName(IP.IphoneIp),8889);
    ...
    public static void sendAlertData(String s){
        /*
        *创建UDP传输的发送端
        * 思路：
        * 1.建立udp的socket服务（new socket)
