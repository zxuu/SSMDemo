...
<form action="zhe" method="post">
<div >
			<input id="loginname" class="itext" type="text" name="name" tabindex="1" autocomplete="off"
			placeholder="输入幼儿姓名">
			<input id="loginbut" type="submit" name="login_sub" value="搜  索" tabindex="4">
		
		</div>
		</form>
        <div class="row placeholders">
<div id="temp" style="width: 1000px;height:400px;"></div>
<div id="humi" style="width: 1000px;height:400px;"></div>
</div></div>
